     ...
     <%@page import="java.sql.DriverManager"%>
       ...
       <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM complaints WHERE complaint_status = 'done' AND complaint_category = 'cleaner' AND complaint_done_by = '"+ session.getAttribute("USER_NUMBER") +"'  ORDER BY complaint_id DESC";
