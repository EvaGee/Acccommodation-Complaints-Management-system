      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="carpenterDoneComplaints.jsp">Done</a>
     ...
     <%@page import="java.sql.DriverManager"%>
       ...
       <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM complaints WHERE complaint_status = 'assigned' AND complaint_category = 'carpenter' AND complaint_assigned_to = "+session.getAttribute("USER_NUMBER")+" AND complaint_done_by ='none' ORDER BY complaint_id DESC";
        			...
        			<tr>
        		    	...
        		    	<td><a href='carpenterView.jsp/carpenter/done/<%out.println(resultSet.getString("complaint_id")); %>/<%=session.getAttribute("USER_NUMBER")%>'>Done</a></td>
