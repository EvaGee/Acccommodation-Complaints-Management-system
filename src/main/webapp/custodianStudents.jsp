       ...
       <table class="table table-secondary container">
               ...
               <td>User ID</td>
                ...
                try{
        			...
        			String sql ="SELECT * FROM users WHERE user_role = 'student' AND user_hostel = '"+ session.getAttribute("USER_HOSTEL") +"' ORDER BY user_id DESC";
		    	...
		    	<td>
		    		<form action="reportStudent" method="post">
     					<input type="hidden" name="userNumber" value="<%out.println(resultSet.getString("user_number")); %>">
