    ...
    <div class="container-fluid bg">
		<div class="container">
            ...
            <form class="form-container" method="post" action="/submitComplaint" id="complaintForm" name="complaintForm" onsubmit="return formValidate()">
                <br>
                <button type="button" class="btn btn-dark btn-block" onClick="window.location.href='status.jsp'">Click Here To See <%=session.getAttribute("USER_FIRSTNAME") %>'s Complaint Status</button>
                <br>
