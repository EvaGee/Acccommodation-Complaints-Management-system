     ...
     <%@page import="java.sql.DriverManager"%>
       ...
       <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM complaints WHERE complaint_status = 'assigned' AND complaint_category = 'security' AND complaint_assigned_to = "+session.getAttribute("USER_ID")+" AND complaint_done_by = 0 ORDER BY complaint_id DESC";
        			...
        			<tr>
        		    	...
        		    	<td><a href='securityView.jsp/security/done/<%out.println(resultSet.getString("complaint_id")); %>/<%=session.getAttribute("USER_ID")%>'>Done</a></td>
        			</tr>
        			<% 
			}
