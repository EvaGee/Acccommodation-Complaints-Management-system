...
<hr class="sidebar-divider">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Health Officers</h2>
     ...
     <%@page import="java.sql.DriverManager"%>
      ...
      <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM users WHERE user_role = 'health' ORDER BY user_id DESC";
