...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="healthUI.jsp">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="healthUI.jsp">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	 <a class="collapse-item" href="healthView.jsp">View Complaints</a>
            <a class="collapse-item" href="healthDoneComplaints.jsp">Done</a>
     ...
     <%@page import="java.sql.DriverManager"%>
       ...
       <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM complaints WHERE complaint_status = 'done' AND complaint_category = 'health' AND complaint_done_by = "+ session.getAttribute("USER_ID") +" AND complaint_assigned_to = "+ session.getAttribute("USER_ID") +" ORDER BY complaint_id DESC";
        			...
        			<tr>
        		    	...
        		    	<td><a href='healthDoneComplaints.jsp/health/undo/<%out.println(resultSet.getString("complaint_id")); %>'>Undo</a></td>
        			</tr>
