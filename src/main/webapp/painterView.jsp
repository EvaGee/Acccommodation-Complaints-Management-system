...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-light sidebar  sidebar-brand" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="painterUI.jsp">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="painterUI.jsp">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          	 <a class="collapse-item" href="painterView.jsp">View Complaints</a>
            <a class="collapse-item" href="painterDoneComplaints.jsp">Done</a>
     ...
     <%@page import="java.sql.DriverManager"%>
       ...
       <table class="table table-secondary container">
                ...
                try{
        			...
        			String sql ="SELECT * FROM complaints WHERE complaint_status = 'assigned' AND complaint_category = 'painter' AND complaint_assigned_to = "+session.getAttribute("USER_NUMBER")+" AND complaint_done_by ='none' ORDER BY complaint_id DESC";
        			...
        			<tr>
        		    	...
        		    	<td><a href='painterView.jsp/painter/done/<%out.println(resultSet.getString("complaint_id")); %>/<%=session.getAttribute("USER_NUMBER")%>'>Done</a></td>
        			</tr>
        			<% 
			}
